...
public class EntityScores implements Model
{
	 ...
	 */
	public EntityStructureGroup getEntity()
	{
		return  this.entity;
	 ...
	 */
	public void setEntity(EntityStructureGroup entity)
	{
		 this.entity = entity;
	 ...
	 */
	public ScoringRuleStructure getScoringRule()
	{
	 ...
	 */
	public void setScoringRule(ScoringRuleStructure scoringRule)
	{
