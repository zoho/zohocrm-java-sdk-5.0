...
public class ResponseWrapper implements Model, ResponseHandler
{
	 ...
	 * @return An instance of List<GetEmailSharing>
	 */
	public List<GetEmailSharing> getEmailssharingdetails()
	{
	 ...
	 * @param emailssharingdetails An instance of List<GetEmailSharing>
	 */
	public void setEmailssharingdetails(List<GetEmailSharing> emailssharingdetails)
	{
