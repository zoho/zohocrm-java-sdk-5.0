...
public class NotesOperations
{
	...
	{
		public static final Header<String> IF_MODIFIED_SINCE = new Header<String>("If-Modified-Since", "com.zoho.crm.api.Notes.GetNotesHeader");
	...
	{
		public static final Header<String> IF_MODIFIED_SINCE = new Header<String>("If-Modified-Since", "com.zoho.crm.api.Notes.GetNoteHeader");
