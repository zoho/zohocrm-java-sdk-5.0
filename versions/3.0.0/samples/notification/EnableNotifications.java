						...
						if (actionResponse instanceof SuccessResponse)
						{
							...
							for (Map.Entry<String, Object> entry : successResponse.getDetails().entrySet())
							{
								if (entry.getValue() instanceof List)
								{
									...
									if (dataList.size() > 0 && dataList.get(0) instanceof com.zoho.crm.api.notifications.Notification)
									{
										@SuppressWarnings("unchecked")
										List<com.zoho.crm.api.notifications.Notification> eventList = (List<com.zoho.crm.api.notifications.Notification>) dataList;
										for (com.zoho.crm.api.notifications.Notification event : eventList)
										{
