		...
		if (response != null)
		{
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					List<Info> info = responseWrapper.getInfo();
					for (Info info1 : info)
					{
						if (info1 != null)
						{
							...
							{
								System.out.println("RelatedRecord Info PerPage: " + info1.getPerPage().toString());
							}
							if (info1.getCount() != null)
							{
								System.out.println("RelatedRecord Info Count: " + info1.getCount().toString());
							}
							if (info1.getPage() != null)
							{
								System.out.println("RelatedRecord Info Page: " + info1.getPage().toString());
							}
							if (info1.getMoreRecords() != null)
							{
								System.out.println("RelatedRecord Info MoreRecords: " + info1.getMoreRecords().toString());
							}
						}
					}
				}
