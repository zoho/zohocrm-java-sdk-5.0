...
public class TimelinesOperations
{
	...
	{
		public static final Param<String> INCLUDE_INNER_DETAILS = new Param<String>("include_inner_details", "com.zoho.crm.api.Timelines.GetTimelinesParam");

		public static final Param<String> SORT_BY = new Param<String>("sort_by", "com.zoho.crm.api.Timelines.GetTimelinesParam");

		public static final Param<String> SORT_ORDER = new Param<String>("sort_order", "com.zoho.crm.api.Timelines.GetTimelinesParam");
		...
		public static final Param<String> INCLUDE = new Param<String>("include", "com.zoho.crm.api.Timelines.GetTimelinesParam");
