...
{
	public static void updateLockReasonOfARecord(Long recordId, String moduleName, long lockId) throws Exception
	{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			updateLockReasonOfARecord(recordId, moduleAPIName, lockId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
