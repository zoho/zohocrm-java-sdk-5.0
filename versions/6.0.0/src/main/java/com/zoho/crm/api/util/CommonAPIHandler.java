...
public class CommonAPIHandler
{
	...
	public <T> APIResponse<T> apiCall(Class<T> className, String encodeType) throws SDKException
	{
		...
		try
		{
			connector.addHeader(Constants.ZOHO_SDK, System.getProperty("os.name") + "/" + System.getProperty("os.version") + "/java-5.0/" + System.getProperty("java.version") + ":" + Constants.SDK_VERSION);
