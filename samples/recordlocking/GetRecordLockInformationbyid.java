...
import com.zoho.crm.api.recordlocking.RecordLockingOperations.getrecordlockinformationParam;
...
public class GetRecordLockInformationbyid
{
	...
	public static void getRecordLockInformationbyid(String moduleAPIName, Long recordId, Long lockId) throws Exception
	{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			getRecordLockInformationbyid(moduleAPIName, recordId,lockId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
