...
{
	public static void removeLockForARecord(Long recordId, String moduleName, long lockId) throws Exception
	{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			removeLockForARecord(recordId, moduleAPIName, lockId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
